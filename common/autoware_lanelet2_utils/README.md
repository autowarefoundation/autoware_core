...
| `lane_changeable_neighbors`        | Get **all** adjacent and same_direction lanelets on the routing graph if exists that have lane change permission <br> Post Condition: <br> Output is ordered from **leftmost** lanelet to **rightmost** lanelet (including input `lanelet`).                                                                                                                               | $O(E)$ where $E$ is the number of all neighbor lanelets (both left and right).                                          |                                                                                                                                                                                                                                                                                                                                                                             |
