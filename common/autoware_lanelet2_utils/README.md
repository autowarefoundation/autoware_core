...
| `all_neighbor_lanelets`    | Get **all** adjacent and same_direction lanelets on the routing graph if exists regardless of lane change permission <br> Post Condition: <br> Output is ordered from **leftmost** lanelet to `lanelet` to **rightmost** lanelet. | $O(E)$ where $E$ is the number of all neighbor lanelets (both left and right).     |                                                                                                                                                                                                                                                                                                                                                                             |
