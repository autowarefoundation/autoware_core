...
| `get_lateral_distance_to_centerline`      | Find distance of search pose to centerline (distance in `ArcCoordinates`).                                                                                                                                                                                                                                                    |                                  | ![get_lateral_distance_to_centerline](./media/api/geometry/get_lateral_distance_to_centerline.drawio.svg)<br>[Open]({{ drawio("/common/autoware_lanelet2_utils/media/api/geometry/get_lateral_distance_to_centerline.drawio.svg") }})                |
| `get_lateral_distance_to_closest_lanelet` | Find distance of search pose to the closest lanelet's centerline in lanelet sequence (distance in `ArcCoordinates`).                                                                                                                                                                                                          |                                  | ![get_lateral_distance_to_closest_lanelet](./media/api/geometry/get_lateral_distance_to_closest_lanelet.drawio.svg)<br>[Open]({{ drawio("/common/autoware_lanelet2_utils/media/api/geometry/get_lateral_distance_to_closest_lanelet.drawio.svg") }}) |
