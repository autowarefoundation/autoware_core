...
Test maps are structured based on the [Autoware Vector map specifications](https://autowarefoundation.github.io/autoware-documentation/main/design/autoware-architecture-v1/map/map-requirements/vector-map-requirements-overview/).
