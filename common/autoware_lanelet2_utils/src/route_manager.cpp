...
std::optional<lanelet::ConstLanelet> RouteManager::get_closest_preferred_lanelet(
  const geometry_msgs::msg::Pose & search_pose) const
{
  return preferred_route_rtree_.get_closest_lanelet(search_pose.position);
}

std::optional<lanelet::ConstLanelet> RouteManager::get_closest_lanelet_within_constraints(
