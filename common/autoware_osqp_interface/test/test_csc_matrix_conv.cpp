...
TEST(TestCscMatrixConv, Nominal)
{
  ...
  EXPECT_EQ(rect_m1.m_row_idxs[0], OSQPInt(0));
  ASSERT_EQ(rect_m1.m_col_idxs.size(), size_t(3));  // nb of columns + 1
  EXPECT_EQ(rect_m1.m_col_idxs[0], OSQPInt(0));
  EXPECT_EQ(rect_m1.m_col_idxs[1], OSQPInt(0));
  EXPECT_EQ(rect_m1.m_col_idxs[2], OSQPInt(1));
  ...
  EXPECT_EQ(rect_m2.m_row_idxs[0], OSQPInt(0));
  EXPECT_EQ(rect_m2.m_row_idxs[1], OSQPInt(1));
  EXPECT_EQ(rect_m2.m_row_idxs[2], OSQPInt(0));
  EXPECT_EQ(rect_m2.m_row_idxs[3], OSQPInt(1));
  ASSERT_EQ(rect_m2.m_col_idxs.size(), size_t(5));  // nb of columns + 1
  EXPECT_EQ(rect_m2.m_col_idxs[0], OSQPInt(0));
  EXPECT_EQ(rect_m2.m_col_idxs[1], OSQPInt(1));
  EXPECT_EQ(rect_m2.m_col_idxs[2], OSQPInt(2));
  EXPECT_EQ(rect_m2.m_col_idxs[3], OSQPInt(4));
  EXPECT_EQ(rect_m2.m_col_idxs[4], OSQPInt(4));
  ...
  EXPECT_EQ(square_m2.m_row_idxs[0], OSQPInt(0));
  EXPECT_EQ(square_m2.m_row_idxs[1], OSQPInt(1));
  EXPECT_EQ(square_m2.m_row_idxs[2], OSQPInt(3));
  EXPECT_EQ(square_m2.m_row_idxs[3], OSQPInt(1));
  EXPECT_EQ(square_m2.m_row_idxs[4], OSQPInt(2));
  EXPECT_EQ(square_m2.m_row_idxs[5], OSQPInt(4));
  EXPECT_EQ(square_m2.m_row_idxs[6], OSQPInt(5));
  EXPECT_EQ(square_m2.m_row_idxs[7], OSQPInt(2));
  EXPECT_EQ(square_m2.m_row_idxs[8], OSQPInt(3));
  EXPECT_EQ(square_m2.m_row_idxs[9], OSQPInt(2));
  EXPECT_EQ(square_m2.m_row_idxs[10], OSQPInt(3));
  EXPECT_EQ(square_m2.m_row_idxs[11], OSQPInt(4));
  EXPECT_EQ(square_m2.m_row_idxs[12], OSQPInt(0));
  EXPECT_EQ(square_m2.m_row_idxs[13], OSQPInt(3));
  EXPECT_EQ(square_m2.m_row_idxs[14], OSQPInt(4));
  EXPECT_EQ(square_m2.m_row_idxs[15], OSQPInt(5));
  EXPECT_EQ(square_m2.m_row_idxs[16], OSQPInt(1));
  EXPECT_EQ(square_m2.m_row_idxs[17], OSQPInt(4));
  EXPECT_EQ(square_m2.m_row_idxs[18], OSQPInt(5));
  ASSERT_EQ(square_m2.m_col_idxs.size(), size_t(7));  // nb of columns + 1
  EXPECT_EQ(square_m2.m_col_idxs[0], OSQPInt(0));
  EXPECT_EQ(square_m2.m_col_idxs[1], OSQPInt(3));
  EXPECT_EQ(square_m2.m_col_idxs[2], OSQPInt(7));
  EXPECT_EQ(square_m2.m_col_idxs[3], OSQPInt(9));
  EXPECT_EQ(square_m2.m_col_idxs[4], OSQPInt(12));
  EXPECT_EQ(square_m2.m_col_idxs[5], OSQPInt(16));
  EXPECT_EQ(square_m2.m_col_idxs[6], OSQPInt(19));
}
TEST(TestCscMatrixConv, Trapezoidal)
{
  ...
  EXPECT_EQ(square_m1.m_row_idxs[0], OSQPInt(0));
  EXPECT_EQ(square_m1.m_row_idxs[1], OSQPInt(0));
  EXPECT_EQ(square_m1.m_row_idxs[2], OSQPInt(1));
  ASSERT_EQ(square_m1.m_col_idxs.size(), size_t(3));
  EXPECT_EQ(square_m1.m_col_idxs[0], OSQPInt(0));
  EXPECT_EQ(square_m1.m_col_idxs[1], OSQPInt(1));
  EXPECT_EQ(square_m1.m_col_idxs[2], OSQPInt(3));
  ...
  EXPECT_EQ(square_m2.m_row_idxs[0], OSQPInt(0));
  EXPECT_EQ(square_m2.m_row_idxs[1], OSQPInt(1));
  EXPECT_EQ(square_m2.m_row_idxs[2], OSQPInt(1));
  ASSERT_EQ(square_m2.m_col_idxs.size(), size_t(4));
  EXPECT_EQ(square_m2.m_col_idxs[0], OSQPInt(0));
  EXPECT_EQ(square_m2.m_col_idxs[1], OSQPInt(0));
  EXPECT_EQ(square_m2.m_col_idxs[2], OSQPInt(2));
  EXPECT_EQ(square_m2.m_col_idxs[3], OSQPInt(3));
