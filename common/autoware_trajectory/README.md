...
```cpp title="./examples/example_pretty_trajectory.cpp:92:95"
--8<--
common/autoware_trajectory/examples/example_pretty_trajectory.cpp:92:95
--8<--
```
