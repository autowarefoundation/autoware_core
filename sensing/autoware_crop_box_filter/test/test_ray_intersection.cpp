...
using autoware::crop_box_filter::CropBox;
using autoware::crop_box_filter::does_line_segment_intersect_crop_box;
...
static autoware::crop_box_filter::CropBox box = {1, 4, 2, 5, -1, 1};
