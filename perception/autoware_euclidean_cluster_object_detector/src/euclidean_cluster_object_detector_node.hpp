...
private:
   ...
   *        Basically this is the brute-force approach without downsampling, a.k.a slower but
   * accurate (I guess?). This algorithm loads point cloud into 3D KD-Tree for O(logN) nearest
   * neighbor search, then performs clustering based on distance tolerance and min/max cluster size.
   *
