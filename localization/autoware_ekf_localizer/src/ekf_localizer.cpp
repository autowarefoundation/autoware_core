...
EKFModule::EKFModule(const HyperParameters & params)
...
geometry_msgs::msg::PoseStamped EKFModule::get_current_pose(bool get_biased_yaw) const
{
...
geometry_msgs::msg::TwistStamped EKFModule::get_current_twist() const
{
