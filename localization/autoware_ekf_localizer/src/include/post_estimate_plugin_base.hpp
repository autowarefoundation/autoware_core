...
#ifndef POST_ESTIMATE_PLUGIN_BASE_HPP_
#define POST_ESTIMATE_PLUGIN_BASE_HPP_
...
class PostEstimatePluginBase
{
public:
  PostEstimatePluginBase() = default;
  virtual ~PostEstimatePluginBase() = default;
...
#endif  // POST_ESTIMATE_PLUGIN_BASE_HPP_
