...
private:
  ...
  Sub<autoware::component_interface_specs::system::OperationModeState, NodeT> sub_state_;
  Cli<autoware::component_interface_specs::system::ChangeOperationMode, NodeT> cli_mode_;
  Cli<autoware::component_interface_specs::system::ChangeAutowareControl, NodeT> cli_control_;
